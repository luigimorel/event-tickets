	...
	<div class=" mx-auto container">
		...
		<div class="mx-6 py-10  md:text-left">
			...
			<div class="">
				...
				<p class="mb-4">
					<a href="#!" class="text-white">Fundraisers</a>
				</p>
				<p class="mb-4">
					<a href="#!" class="text-white">Online Events</a>
				</p>
				<p class="mb-4">
					<a href="#!" class="text-white">Physical Events</a>
				</p>
			</div>
			...
			<div class="">
				...
				<p class="mb-4">
					<a href="/create-account" class="text-white">Create Account</a>
				</p>
				<p class="mb-4">
			...
			<div class="">
				...
				<p class="flex items-center md:justify-start mb-4">
					...
					<a href="mailto:info@tickets.com">info@tickets.com</a>
				</p>
				<p class="flex items-center md:justify-start mb-4">
					<svg
						aria-hidden="true"
					...
					<a href="tel:+256 764 567 889">+ 256 764 567 889</a>
				</p>
