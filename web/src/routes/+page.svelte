...
<div class=" flex flex-col max-w-screen-xl mx-auto">
	<h2 class=" text-center mb-8 text-3xl font-bold uppercase">Experience fundraisings</h2>
...
<div class=" flex flex-col max-w-screen-xl mx-auto">
	<h2 class=" text-center mb-8 text-3xl font-bold uppercase">Experience concerts</h2>
	<div class=" grid lg:grid-cols-4 md:grid-cols-3 gap-8 px-4 md:px-0 mb-10 md:mb-0 grid-cols-1">
		<!-- { $events.length === 0 ?
			<p>Failed to fetch events </p> : ""
		} -->
